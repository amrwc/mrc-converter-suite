...
package Converters::Passwordwallet;
...
=head1 PasswordWallet converter module

=head2 Platforms

=over

=item B<macOS>: Initially tested with version 4.8.1 (6095)

=item B<Windows>: Initially tested with version 4.8.1 (1147)
...
Export its database as a text file using the C<< File > Export > Visible entries to text file... >> menu.
Enter the wallet's password when the password dialog appears.
